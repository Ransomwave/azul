...
- - [x] 🧳 **Fully hermetic builds**: `azul pack` serializes Studio instance properties/attributes into the `sourcemap.json`, allowing for fully hermetic and reproductible projects.
